        ...
        try {
            ...
            const res = await fetch('/api/checkout', {
                ...
                body: JSON.stringify({
                    ...
                    promoCode: promoCode // [NEW] Send promo code
                    ...
                    <div className="max-w-md mx-auto mb-12">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-center text-white placeholder-gray-600 focus:outline-none focus:border-violet-500 transition-colors uppercase tracking-widest font-bold"
                            />
                            {promoCode === 'HAPPY90' && (
                        ...
                        {promoCode === 'HAPPY90' && (
                            <p className="text-emerald-400 text-xs text-center mt-2 font-bold animate-fade-in">
                                ¡Código válido! Se aplicará 90% de descuento.
                            </p>
                        )}
                    </div>
                </div>
