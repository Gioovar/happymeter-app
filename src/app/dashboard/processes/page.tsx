...
import { ProcessZoneCard } from '@/components/processes/ProcessZoneCard';
...
export default async function ProcessesPage() {
    ...
    try {
        const zonesPromise = prisma.processZone.findMany({
            where: {
                OR: [
                    ...
                    { branchId: effectiveUserId } // Support global view mapping to branches
                ]
            },
            include: {
                _count: {
        ...
        const statsPromise = getDashboardProcessStats(effectiveUserId);
    ...
    const newFlowLink = `/dashboard/processes/new`;
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-400 mt-2 max-w-2xl">
                        Panel de control operativo maestro. Monitorea el cumplimiento en todas tus zonas.
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    {/* InviteStaffButton would normally go here, but global uses a different invite flow usually. We can omit it or add a global one later */}
