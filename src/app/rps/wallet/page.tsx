        ...
        <main className="min-h-screen bg-[#050505] text-white selection:bg-indigo-500/30 font-sans pb-24">
            ...
            <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#0a0a0f] pt-[env(safe-area-inset-top,0px)]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between relative">
                    ...
                    {/* Left: Wallet Icon */}
                    <div className="w-10 h-10 rounded-xl bg-indigo-600/20 flex items-center justify-center border border-indigo-500/30 shrink-0 z-10">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none px-14">
                        <h1 className="text-[16px] font-bold text-white tracking-tight truncate w-full text-center">
                            Mi Billetera RP
                        </h1>
