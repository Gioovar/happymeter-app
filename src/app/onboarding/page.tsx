                                        ...
                                        <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                                            <div className="flex flex-col sm:flex-row gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 bg-black/50 border border-white/10 rounded-lg px-4 py-3 sm:py-2 text-center text-white tracking-[0.5em] font-mono focus:ring-2 focus:ring-violet-500 outline-none"
                                                    maxLength={6}
                                                />
                                                <button
                                                    type="button"
                                                    ...
                                                    className="w-full sm:w-auto px-6 py-3 sm:py-2 bg-violet-600 hover:bg-violet-500 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition flex items-center justify-center"
                                                >
