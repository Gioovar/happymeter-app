...
export default function ProfileSetupForm({ initialData, email }: ProfileSetupFormProps) {
    ...
    return (
        <div className="space-y-6">
            <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
                ...
                {/* Email Display */}
                {email && (
                    <div className="flex items-center gap-3 bg-slate-950/50 p-3 rounded-xl border border-slate-800/50">
                        <div className="p-2 bg-slate-800 rounded-full">
                            <Mail className="w-4 h-4 text-slate-400" />
                        </div>
                        <div className="overflow-hidden">
                            <p className="text-[10px] uppercase font-bold text-slate-500">Cuenta vinculada</p>
            ...
            <div className="flex justify-center">
                <SignOutButton redirectUrl="/ops/login">
                    <button className="flex items-center gap-2 text-red-400 hover:text-red-300 text-sm font-medium px-4 py-2 hover:bg-red-950/30 rounded-lg transition-colors">
