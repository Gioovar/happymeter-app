...
export function PointsLoyaltyView({ userId, program, onBack }: PointsLoyaltyViewProps) {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] p-6 font-sans flex flex-col h-screen overflow-hidden">
            {/* Header */}
            <div className="flex items-center gap-4 mb-8 shrink-0">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white">Configurar Lealtad por Puntos</h1>
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-0">
                ...
                {/* LEFT: CONFIGURATION */}
                <div className="bg-[#111] border border-white/10 rounded-3xl p-8 overflow-y-auto custom-scrollbar flex flex-col gap-8">
                    ...
                    <div className="bg-blue-900/10 border border-blue-500/20 p-6 rounded-2xl">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h3 className="text-lg font-bold text-white mb-1">Regla de Conversión</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <button
                                        ...
                                        className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-xl font-bold text-sm transition-colors"
                                    >
                                        {isSavingSettings ? "Guardando..." : "Guardar Regla"}
                                    </button>
                                </div>
                                <p className="text-xs text-gray-500 mt-3">
                                    Ejemplo: Si la cuenta es de <span className="text-white">$100</span>, el cliente recibe <span className="text-blue-400 font-bold">{Math.floor(100 * (pointsPercentage / 100))} Puntos</span>.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-[#1A1A1A] p-4 rounded-xl border border-white/10">
                            ...
                            <div className="flex gap-3">
                                <input
                                    placeholder="Nombre (Ej. Pizza Gratis)"
                                    className="flex-1 bg-black/30 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:border-blue-500 outline-none"
                                ...
                                <div className="w-24 relative">
                                    <input
                                        type="number"
                                        placeholder="Costo"
                                        className="w-full bg-black/30 border border-white/10 rounded-lg pl-3 pr-1 py-2 text-white text-sm focus:border-blue-500 outline-none"
                                ...
                                <button
                                    ...
                                    className="bg-white text-black px-4 rounded-lg font-bold text-sm hover:bg-gray-200 transition-colors"
                                >
                ...
                {/* RIGHT: PREVIEW */}
                <div className="bg-[#050505] rounded-[40px] border-[8px] border-[#222] shadow-2xl relative overflow-hidden flex flex-col max-w-[400px] mx-auto w-full">
                    {/* Fake Status Bar */}
                    ...
                    <div className="flex-1 bg-black relative overflow-y-auto custom-scrollbar pb-6">
                        <CustomerLoyaltyCard
                            ...
                            customer={{
                                ...
                                visits: [], // Won't rely on visits
                                currentVisits: 0,
                                totalPoints: calculatedPoints, // Simulate accumulation
