    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] p-6 font-sans flex flex-col h-screen overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-8 shrink-0">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white">Configurar Lealtad por Visitas</h1>
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-0">
                ...
                {/* LEFT: CONFIGURATION */}
                <div className="bg-[#111] border border-white/10 rounded-3xl p-8 overflow-y-auto custom-scrollbar">
