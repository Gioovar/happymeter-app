                            ...
                            {!newAccessCode ? (
                                ...
                                <div className="space-y-6 py-4">
                                    <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-center space-y-4">
                                        ...
                                        <Button
                                            onClick={() => {
                                                const url = typeof window !== 'undefined' ? window.location.origin : 'https://happymeters.com'
                                                const message = `¡Hola ${operatorName}! Tu código de acceso para HappyMeter es: *${newAccessCode}*\n\nIngresa aquí: ${url}/ops`
                                                window.open(`https://wa.me/?text=${encodeURIComponent(message)}`, '_blank')
                                            }}
                                            className="w-full mt-4 bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center gap-2"
                                        >
