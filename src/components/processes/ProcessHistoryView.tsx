                    ...
                    <div className="bg-[#111] border border-white/10 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex items-end justify-between mb-2">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 font-medium uppercase tracking-wider mt-1">Cumplimiento</p>
                            </div>
                            <div className="h-10 w-10">
                                <PieChart className="w-full h-full text-gray-600 opacity-20" />
                            </div>
                        </div>
                        ...
                        <div className="w-full bg-gray-800/50 rounded-full h-2 mb-6 overflow-hidden">
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    completionRate >= 80 ? "bg-gradient-to-r from-green-500 to-emerald-400 shadow-green-500/20" :
                                        completionRate >= 50 ? "bg-gradient-to-r from-yellow-500 to-orange-400 shadow-yellow-500/20" :
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-white/5 rounded-2xl p-4 border border-white/5 backdrop-blur-sm">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className="text-2xl font-bold text-white">{data.stats?.completed || 0}</span>
                                </div>
                            ...
                            <div className="bg-white/5 rounded-2xl p-4 border border-white/5 backdrop-blur-sm">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className="text-2xl font-bold text-white">{data.stats?.missed || 0}</span>
                                </div>
                                <p className="text-xs text-gray-400 font-medium">No Realizadas</p>
                            </div>
                        </div>
                    </div>
                )}
