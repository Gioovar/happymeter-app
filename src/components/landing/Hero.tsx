        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center pt-20">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                    ...
                    <Link href="/s/demo">
                        <button className="px-8 py-4 rounded-full bg-white/5 text-white font-medium text-lg border border-white/10 hover:bg-white/10 transition duration-300 backdrop-blur-sm">
                            Ver Demo
                        </button>
                    </Link>
                </div>
