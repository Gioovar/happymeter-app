...
export default function DashboardChatView() {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (threads.length > 0) {
                        ...
                        // Reset if no threads found for this context
                        ...
                        <div>
                            <h1 className="text-lg md:text-xl font-bold text-white flex items-center gap-2">
                                ...
                                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 truncate">
                                    Centro de Inteligencia {branchSlug && <span className="text-xs text-gray-400 font-normal ml-2 bg-white/10 px-2 py-0.5 rounded-full">Sucursal</span>}
                                </span>
                            </h1>
                        </div>
                    </div>
