...
export default function HeatmapWidget() {
    ...
    const fetchHeatmapData = async () => {
        ...
        try {
            ...
            // Use branchSlug if available to match the API logic
            const currentSlug = branchSlug || branchId;

            // We'll hit our reputation endpoint to get the latest DB score, passing branchSlug if any.
            const url = currentSlug
                ? `/api/ai/reputation?limit=1&branchSlug=${currentSlug}`
